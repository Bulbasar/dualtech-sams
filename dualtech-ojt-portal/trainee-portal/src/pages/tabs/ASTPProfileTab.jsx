...
const ASTPProfileTab = ({ profile, user, db, appId, auth }) => {
    // States
                ...
                <div className="space-y-5">
                    <div>
                        ...
                        <p className="font-medium text-slate-800 dark:text-slate-100 flex items-center gap-2">
                            <Award size={16} className="text-blue-500" /> ASTP
                        </p>
                    </div>
                    <div>
                        <p className="text-xs font-bold text-slate-400 uppercase mb-1">Assigned Company</p>
                        <p className="font-medium text-slate-800 dark:text-slate-100 flex items-center gap-2">
                            <MapPin size={16} className="text-blue-500" />{profile?.companyName || 'N/A'}
                        </p>
                    </div>
                    <div>
                        <p className="text-xs font-bold text-slate-400 uppercase mb-1">Coordinator (IC)</p>
                        <p className="font-medium text-slate-800 dark:text-slate-100 flex items-center gap-2">
                            <User size={16} className="text-blue-500" />{profile?.assignedIC || 'N/A'}
                        </p>
                    </div>
                    <div>
                        <p className="text-xs font-bold text-slate-400 uppercase mb-1">IPT Schedule</p>
                        <p className="font-medium text-slate-800 dark:text-slate-100 flex items-center gap-2">
                            <Calendar size={16} className="text-blue-500" />{profile?.iptDateStart || 'TBA'} to {profile?.iptDateEnd || 'TBA'}
                        </p>
                    </div>
                    <div>

                  ...
                  if (user && adminData) {
                      ...
                      const unsub = onSnapshot(q, (snap) => {
                          ...
                          snap.forEach(d => {
                              ...
                              // Ignore notifications meant for LF (either via targetGroup="LF" or having targetInitials and not explicitly "ADMIN")

...
const brokenBlock = `              <div className="bg-blue-600 p-10 text-white text-center">
...
const fixedBlock = `              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-10 text-white text-center relative overflow-hidden">
...
console.log('Restored and Fixed LF Portal Login UI completely');

                        ...
                        <div className="xl:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col transition-colors">
                            ...
                            {viewMode === 'table' ? (
                                <>
                                    ...
                                    <h3 className="font-bold text-slate-800 dark:text-white flex items-center gap-2 shrink-0">font-bold text-slate-800 dark:text-white flex items-center gap-2 shrink-0"></h3>

...
<head>
    ...
    <title>IC Management Portal - Dualtech</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
    <script src="https://cdn.tailwindcss.com" data-html2canvas-ignore="true"></script>
    <script>
        tailwind.config = {
            darkMode: 'class',
            theme: {
    ...
    <style>
        ...
        /* Fix input and textarea text color in dark mode */
        .dark input,
        .dark textarea,
        .dark select {
            color: #f1f5f9;
...
<body class="bg-gray-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 overflow-hidden h-screen w-screen">
                    ...
                    <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-white dark:bg-slate-800 dark:bg-slate-900">
                        ...
                        <header className="h-16 flex items-center justify-between px-4 md:px-6 border-b border-slate-200 dark:border-slate-700 dark:border-slate-700 relative z-30">
                            ...
                            <div className="flex items-center gap-2 md:gap-4 pl-4">
                                <button 
                                    ...
                                    className="text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 p-2 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        ...
                        <div className="flex-1 overflow-y-auto p-4 md:p-8 relative custom-scrollbar">
                            <div className="max-w-6xl mx-auto pb-10">
                                ...
                                {/* TABS ROUTING */}
                                {activeTab === 'dashboard' && <DashboardTab allTrainees={trainees} attendanceLogs={attendanceLogs} registeredStudentIds={registeredStudentIds} />}
